{{-- resources/views/admin/shipping_areas/edit.blade.php --}}
@extends('admin.layouts.app')

@section('title', 'Edit Shipping Area')
        ...
        <div class="col-lg-8 col-md-10">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <form action="{{ route('admin.shipping-areas.update', $shipping_area) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('name_en', $shipping_area->name_en) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('name_ar', $shipping_area->name_ar) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                           ...
                                           value="{{ old('cost', $shipping_area->cost) }}"
                                           required>
                                    @error('cost')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input"
                                           ...
                                           name="is_active"
                                           value="1"
                                           {{ old('is_active', $shipping_area->is_active) ? 'checked' : '' }}>
