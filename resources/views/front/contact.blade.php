...
@section('content')
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <input type="text" name="name"
                                        ...
                                        placeholder="{{ __('contact.placeholder_name') }}" value="{{ old('name') }}"
                                        required>
                                    @error('name')
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="phone"
                                        ...
                                        placeholder="{{ __('contact.placeholder_number') }}" value="{{ old('phone') }}"
                                        required>
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-12">
                                    <input type="email" name="email"
                                        ...
                                        placeholder="{{ __('contact.placeholder_email') }}" value="{{ old('email') }}"
                                        required>
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                                ...
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        @if (!empty($loc['directions_url']))
                                                            <a href="{{ $loc['directions_url'] }}" target="_blank"
    ...
    <style>
        ...
        .contact-input:focus {
            border-color: #843c24;
            box-shadow: 0 0 12px rgba(132, 60, 36, .25);
        }
