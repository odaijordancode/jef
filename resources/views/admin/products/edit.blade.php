                    ...
                    <form action="{{ route('admin.products.update', $product) }}" method="POST"
                        ...
                        <div class="tab-content" id="languageTabsContent">
                            ...
                            <div class="tab-pane fade show active" id="en" role="tabpanel" aria-labelledby="en-tab">
                                <div class="mb-3">
                                    <label for="product_name_en" class="form-label">Product Name (EN) <span
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description_en') is-invalid @enderror" name="description_en" id="editor"
                            ...
                            <div class="tab-pane fade" id="ar" role="tabpanel" aria-labelledby="ar-tab"
                                dir="rtl">
                                <div class="mb-3">
                                    <label for="product_name_ar" class="form-label">Product Name (AR) <span
                                            class="text-danger">*</span></label>
                                    <input type="text"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description_ar') is-invalid @enderror" id="editor" name="description_ar"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('status') is-invalid @enderror" name="status" required>
                                ...
                                <option value="pending"
                                    {{ old('status', $product->status) == 'pending' ? 'selected' : '' }}>Pending</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('quantity') is-invalid @enderror"
                                name="quantity" value="{{ old('quantity', $product->quantity) }}" min="0"
                                required>
                            @error('quantity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
